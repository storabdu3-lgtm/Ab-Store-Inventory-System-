        ...
        <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
          {visibleItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={cn("w-4 h-4 flex-shrink-0", isActive ? "text-blue-400" : "text-sidebar-foreground/60")} />
          ...
          {isAdmin && (
            <>
              ...
              >
                <ShieldCheck className={cn("w-4 h-4 flex-shrink-0", location === "/users" ? "text-blue-400" : "text-sidebar-foreground/60")} />
